...
const structuredData = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Person',
      '@id': 'https://www.mojaa.in/about-mayank#person',
      name: 'Mayank Jain',
      honorificPrefix: 'CA',
      jobTitle: 'Founder',
      url: 'https://www.mojaa.in/about-mayank',
      image: 'https://www.mojaa.in/mayank-jain.webp',
      worksFor: { '@id': 'https://www.mojaa.in/#organization' },
      sameAs: ['https://www.linkedin.com/in/jainmayank13/'],
    },
    {
      '@type': 'ProfilePage',
      ...
      inLanguage: 'en',
      mainEntity: { '@id': 'https://www.mojaa.in/about-mayank#person' },
