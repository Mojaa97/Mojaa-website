...
It is a newly defined category under the 2026 notification, covering startups doing novel scientific or engineering innovation with significant research and development spend, meaningful intellectual property, and a clear plan to commercialise their technology. Typical sectors include AI, biotech, semiconductors, quantum computing and space technology.
...
No. DPIIT determines Deep Tech Startup classification based on specific frameworks and parameters it prescribes, supported by documents and information the applicant submits. Operating in a technical sector is necessary but not sufficient; the R&D intensity, IP ownership and commercialisation plan need to be demonstrated.

**Does the 2026 notification affect the restriction on startups investing in things like residential property or speculative investments?**
That restriction continues under the 2026 notification, but its duration has changed. It previously applied for 7 years from recognition; it now applies throughout the full recognition period, which for a regular startup is 10 years.

**Does raising the turnover ceiling affect tax benefits like the Section 80-IAC holiday automatically?**
DPIIT recognition is a precondition for Section 80-IAC eligibility, but 80-IAC has its own separate conditions, including an Inter-Ministerial Board certificate and specific incorporation and turnover windows under the Income Tax framework. Staying DPIIT recognised for longer widens the period during which you could potentially apply for 80-IAC, but it does not by itself grant the tax holiday.

**What happened to the earlier 2019 notification?**
The 2026 notification dated 4 February 2026 expressly supersedes and replaces the 2019 notification in its entirety. Startups already recognised under the 2019 framework continue, but any fresh interpretation of eligibility, turnover ceilings and duration now follows the 2026 rules.

### Advanced level

**What is the precise legal basis for the 2026 changes?**
DPIIT issued a Gazette Notification dated 4 February 2026, which replaces and supersedes the notification of 19 February 2019 that had governed startup recognition since the Startup India initiative began. The new notification restates the definition of a startup, introduces the formal definition of a Deep Tech Startup for the first time, and revises the entity types, age limits and turnover ceilings applicable to each category.

**Does the extended recognition period change eligibility for schemes tied to a startup's age, such as the Startup India Seed Fund Scheme?**
The Seed Fund Scheme and similar schemes have their own eligibility windows, which are typically narrower than the full DPIIT recognition period and are aimed at early stage validation, proof of concept and market entry. A longer DPIIT recognition period does not automatically extend eligibility for schemes that are specifically designed for early stage startups; each scheme's own conditions need to be checked independently.

**How does the Deep Tech Startup definition interact with intellectual property ownership, particularly for startups that license rather than own core IP?**
Meaningful ownership of relevant intellectual property is one of the criteria DPIIT considers in Deep Tech classification. A startup that primarily licenses core technology from a third party, rather than owning IP arising from its own research and development, would need to demonstrate the specific nature and extent of its own IP contribution to be classified as Deep Tech.

**Can a startup that was already recognised under the 2019 framework reapply to be classified as Deep Tech under the 2026 framework?**
The 2026 notification allows classification as a Deep Tech Startup based on the frameworks, parameters and documentation DPIIT prescribes for that purpose. A startup already holding regular DPIIT recognition that believes it meets the Deep Tech criteria would need to apply for that specific classification through the process DPIIT has laid out.

**Where can this be verified directly, rather than taken on faith from a summary like this one?**
